  ...
  <div>
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <router-link class="nav-link cursor-pointer" to="/admin/dashboard">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseDocument" aria-expanded="true"
          aria-controls="collapseDocument">
          <i class="fab fa-fw fa-wpforms"></i>
          <span>Documents</span>
        </a>
        <div id="collapseDocument" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Documents</h6>
            <router-link class="collapse-item" to="/admin/add-document">Add Document</router-link>
            <router-link class="collapse-item" to="/admin/all-documents">All Document</router-link> 
          </div>
        </div>
      </li>
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="" style="max-width: 60px" alt="img/man.png">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="" style="max-width: 60px" alt="img/girl.png">
...
const fetchUserDetails = (authToken) => {
  axios.get(`${API_BASE_URL}/api/v1/user-details/`, {
    headers: {
